...
def main():
    ...
    print("Arquivo original criado. Partiremos para a manipulação dos dados.")
    dados_modificados = []
    with open("C:/Users/Arthur/Documents/GitHub/Python-Studies/ManipulacaoDeArquivos/textos/meu_texto.txt", "r") as arquivo:
    ...
    print("O arquivo foi devidamente sobrescrito com os dados modificados!")
