...
def main():
    ...
    img = Image.open("C:/Users/Arthur/Documents/GitHub/Python-Studies/ManipulacaoDeArquivos/simple_icon.png")
    img.show()
    ...
    with open("copy_img.bin", "wb") as copy_file:
        data = copy_file.write(data)

    # Manipulação dos dados do arquivo binário cópia
    # Exemplo: Invertendo os bytes
